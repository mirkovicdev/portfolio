    ...
    >
      <div className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center">
        ...
        <div className="relative z-10 group">
          {/* Outer glow ring */}
          <div className="absolute -inset-8 rounded-full bg-gradient-to-r from-phthalo-500/30 to-phthalo-700/30 blur-xl animate-pulse transition-all duration-500 group-hover:from-phthalo-400/60 group-hover:to-phthalo-600/60 group-hover:-inset-12 group-hover:blur-2xl"></div>

          {/* Rotating border ring */}
          <div
            className="absolute -inset-4 rounded-full bg-gradient-to-r from-phthalo-500 via-phthalo-600 to-phthalo-700 animate-spin"
          ...
          {/* Profile picture */}
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-phthalo-500/50 shadow-2xl">
            <img
              src="/pfpicon.png"
          ...
          <div
            className="absolute -top-8 -left-8 text-phthalo-400 text-2xl font-mono animate-bounce"
            style={{ animationDelay: "0.5s" }}
          >
            {"<>"}
          </div>
          <div
            className="absolute -top-4 -right-12 text-phthalo-500 text-xl font-mono animate-pulse"
            style={{ animationDelay: "1s" }}
          >
            {"{ }"}
          </div>
          <div
            className="absolute -bottom-6 -left-10 text-phthalo-600 text-lg font-mono animate-bounce"
            style={{ animationDelay: "1.5s" }}
          >
            {"</>"}
          </div>
          <div
            className="absolute -bottom-8 -right-8 text-phthalo-400 text-xl font-mono animate-pulse"
            style={{ animationDelay: "2s" }}
          >
            {"( )"}
          </div>
